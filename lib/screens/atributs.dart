...
class Atributs extends StatefulWidget {
  const Atributs({Key? key}) : super(key: key);

  @override
  _AtributsState createState() => _AtributsState();
}

class _AtributsState extends State<Atributs> {
